#!/bin/bash
#SBATCH -J pretrain_PointBERT_mixed_30_excl_BLIP2
#SBATCH -A 
...
/path/to/torchrun \
    ...
    main.py \
        ...
        --warmup-epochs 1 \
        --npoints 8192 \
        --output-dir ./outputs/pointBERT_mixed_30_excl_BLIP2 \
        --epochs 250 \
        --eval-freq 1 \
        --workers 20 \
        --wandb \
        --max-lidar-ratio 0.3 \
        --excluded-classes "pedestrian" "traffic cone" "bus" "motorcycle" \